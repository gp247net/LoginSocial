 ...
 * Plugin format 1.0
 */
#App\GP247\Plugins\LoginSocial\AppConfig.php
namespace App\GP247\Plugins\LoginSocial;

use App\GP247\Plugins\LoginSocial\Models\ExtensionModel;
...
class AppConfig extends ExtensionConfigDefault
{
    ...
    {
        return redirect(gp247_route_admin('admin_loginsocial.index'));
    }
